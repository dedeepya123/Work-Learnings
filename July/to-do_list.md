# date --> 28th July 2026
1. Read about DataClasses
2. Read about enum module in python --> when, where its used ?
3. What does it mean when a mtheos is __add_identitity_args like that
4. Functools
